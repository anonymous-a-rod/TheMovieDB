            ...
            <table className="table-fixed w-full text-xl">
              <tbody className="divide-y divide-gray-600">
                ...
                <tr>
                  ...
                  <td className="w-1/2 py-2 text-right">{item.vote_average}/10</td>
                </tr>
                <tr>
                  <td className="w-1/2 py-2">Budget:</td>
                  <td className="w-1/2 py-2 text-right">${item.budget}</td>
                </tr>
                <tr>
                  <td className="w-1/2 py-2">Revenue:</td>
                  <td className="w-1/2 py-2 text-right">${item.revenue}</td>
                </tr>
              </tbody>
            </table>
        </div>  
